        ...
        local ok, err = pcall(function()
            ...
            if stage == "wait-respawn" then
                if read_u8(inv_turret_death_timer) == 0 then
                    ...
                    test.assert_eq(cell(inv_turret_top_row, inv_turret_start_x + 1), string.byte("_"), "respawn left shoulder")
                    test.assert_eq(cell(inv_turret_top_row, inv_turret_start_x + 2), string.byte("/"), "respawn barrel left")
